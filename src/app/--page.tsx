...
export default function HomePage() {
  return (
    <section className="min-h-[calc(100vh-160px)] bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-2 lg:items-center">
        <div>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <Link
              href="/login"
              className="inline-flex items-center justify-center rounded-xl border border-slate-300 bg-white px-5 py-3 font-semibold text-slate-800 transition hover:bg-slate-50"
            >
              Entrar
            </Link>
          </div>
        ...
        <div className="rounded-3xl border border-white/70 bg-white p-4 shadow-2xl shadow-blue-900/10">
          <div className="rounded-2xl bg-slate-950 p-5 text-white">
            <div className="mb-6 flex items-center justify-between">
              <div>
                <p className="text-sm text-slate-400">Demonstração do sistema</p>
                <h2 className="text-xl font-bold">Dashboard TaskFlow</h2>
              </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              ...
              <div className="rounded-2xl bg-white/10 p-4">
                ...
                <strong className="text-3xl">08</strong>
              </div>
              <div className="rounded-2xl bg-white/10 p-4">
